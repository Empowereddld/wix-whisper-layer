...
const cards = [
  {
    ...
    description: "Our DLD book series features characters from diverse backgrounds. Each book contains a visual glossary. Discussion guides and character-themed strategy posters available in our resource library.",
