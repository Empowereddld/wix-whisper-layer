...
const cards = [
  {
    ...
    description: "Stories that help kids with DLD feel seen and give classmates a way to understand language differences. Each book comes with a visual glossary and can be paired with discussion guides and classroom strategy posters from our resource library.",
