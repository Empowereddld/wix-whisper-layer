    ...
    <section className="py-16 md:py-[80px] bg-muted">
      <div className="container px-6 md:px-8">
        ...
        <div className="max-w-[720px] space-y-5 md:space-y-6">
          <p className={p}>
            Speech and language are connected, but they are not the same thing. Speech is about how sounds are produced. A speech delay may involve difficulty saying certain sounds, being hard to understand, or developing speech sounds later than expected. A language delay involves things like saying less words than their peers, struggling to understand and use language concepts etc. Some late talkers (language delay) catch up, especially when the main issue is early expressive language and other language skills are developing well.
          </p>
          <p className={p}>
            DLD is broader and more persistent. It affects how a person understands and uses language beyond the first several years of life. A person with DLD may stop making obvious grammatical errors but still have difficulty understanding complex sentences, learning vocabulary, answering questions, telling a story, explaining an idea, or organizing written language. In other words, their speech sounds may be clear, but the language system is still working harder.
          </p>
          <p className={p}>
          ...
          <p className={p}>
            The short version is this: a speech delay is usually about speech sound development and a language delay can result in less early talking. DLD is about persistent challenges with the language skills needed to understand, express, learn, read, write, and connect.
          </p>
        </div>
      </div>
    </section>
