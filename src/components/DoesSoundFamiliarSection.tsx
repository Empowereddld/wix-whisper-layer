    ...
    <section className="py-0">
      <div className="container px-6 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          {/* Left — black card with heading */}
          <div className="bg-black text-white flex items-end p-10 md:p-16 min-h-[360px] md:min-h-[520px]">
            <h2 className="text-[28px] md:text-[38px] font-black leading-[1.15]">
              Does this sound familiar?
            </h2>
          </div>

          {/* Right — text content */}
          <div className="flex flex-col justify-center py-10 md:py-16 px-6 md:px-14">
            <p className="text-[14px] md:text-[15px] text-foreground leading-[1.7] mb-6">
            ...
            <p className="text-[14px] md:text-[15px] text-foreground font-semibold mb-3">
              You're noticing:
            </p>
            <ul className="list-disc pl-5 space-y-1.5 text-[14px] md:text-[15px] text-foreground leading-[1.7] mb-6">
