...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 h-[60px] lg:h-[70px] bg-background backdrop-blur-md border-b border-border/20">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10 h-full flex items-center justify-between gap-6">
        <Link to="/" className="flex-shrink-0">
          <img src={logoImage} alt="EmpoweredDLD" className="h-[110px] lg:h-[125px] w-auto" />
        </Link>
