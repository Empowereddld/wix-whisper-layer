...
import { Search, Download, StickyNote } from "lucide-react";
...
const AdminUsers = () => {
  ...
  const exportCSV = () => {
    ...
    const headers = ["Name", "Role", "Country", "Joined"];
          ...
          <Table>
            ...
            <TableBody>
              ...
              {(!users || users.length === 0) && (
                <TableRow>
                  <TableCell colSpan={4} className="text-center text-muted-foreground py-12">No users found</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
