...
.dan-page .story-block .image-side { width: 100%; }
.dan-page .story-block .image-side img { width: 100%; height: 520px; object-fit: cover; object-position: center 35%; border-radius: 12px; box-shadow: 0 18px 50px rgba(31, 22, 64, 0.12); display: block; }
