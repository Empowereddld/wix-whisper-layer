...
const CodeBlock = ({ code }: { code: string }) => (
  <pre className="bg-[#3D2B1F] text-[#D4920B] p-4 rounded-lg overflow-x-auto text-sm font-mono">
    <code>{code}</code>
  </pre>
);
...
const CollapsibleSection = ({ title, children }: { title: string; children: React.ReactNode }) => {
  ...
  return (
    <div className="border border-[#E8DDD0] rounded-lg overflow-hidden mb-4 bg-[#FEFCF9]">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex items-center justify-between p-4 bg-[#F5EDE3] hover:bg-[#F5EDE3] transition-colors"
      >
        <h4 className="font-semibold text-[#3D2B1F]">{title}</h4>
        {isOpen ? <ChevronUp className="h-4 w-4 text-[#D4920B]" /> : <ChevronDown className="h-4 w-4 text-[#D4920B]" />}
      </button>
      {isOpen && <div className="p-4 border-t border-[#E8DDD0]">{children}</div>}
    </div>
  );
};
  ...
  return (
    <AdminLayout>
      <div className="flex gap-6 max-w-7xl mx-auto print:flex-col">
        ...
        >
          <div className="sticky top-20 bg-[#FEFCF9] rounded-lg border border-[#E8DDD0] p-4 max-h-[calc(100vh-120px)] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className={`font-semibold text-sm text-[#5C4033] ${!sidebarOpen ? "hidden" : ""}`}>Sections</h3>
              <button
                onClick={() => setSidebarOpen(!sidebarOpen)}
                className="p-1 hover:bg-[#F5EDE3] rounded transition-colors"
              >
                {sidebarOpen ? <ChevronUp className="h-4 w-4 text-[#D4920B]" /> : <ChevronDown className="h-4 w-4 text-[#D4920B]" />}
              </button>
            </div>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${
                      activeSection === section.id
                        ? "bg-[#D4920B]/20 text-[#D4920B] font-medium border-l-2 border-[#D4920B]"
                        : "text-[#8B7355] hover:bg-[#F5EDE3]"
                    }`}
                  >
        ...
        <main className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold text-[#3D2B1F] font-serif italic">StoryBuilders Waitlist Admin Guide</h1>
              <p className="text-[#8B7355] mt-2">Everything you need to run the viral waitlist system</p>
            </div>
            <Button onClick={handlePrint} variant="outline" size="sm" className="print:hidden border-[#E8DDD0] text-[#5C4033] hover:bg-[#F5EDE3]">
          ...
          <section id="getting-started" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#D4920B]/20 flex items-center justify-center">
                <Home className="h-6 w-6 text-[#D4920B]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Getting Started</h2>
            </div>
            ...
            <CollapsibleSection title="System Architecture">
              ...
              <ul className="space-y-2 mb-4 text-sm">
                <li className="flex items-start gap-2">
                  <ArrowRight className="h-4 w-4 mt-1 text-[#D4920B] flex-shrink-0" />
            ...
            <CollapsibleSection title="First-Time Setup Checklist">
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3 p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <CheckCircle2 className="h-5 w-5 text-[#D4920B] flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-[#3D2B1F]">Supabase Migration</p>
                ...
                <div className="flex items-start gap-3 p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <CheckCircle2 className="h-5 w-5 text-[#D4920B] flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-[#3D2B1F]">Resend API Key</p>
                    <p className="text-[#8B7355] text-xs mt-1">
                ...
                <div className="flex items-start gap-3 p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <CheckCircle2 className="h-5 w-5 text-[#D4920B] flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-[#3D2B1F]">Deploy Edge Functions</p>
                    <p className="text-[#8B7355] text-xs mt-1">
            ...
            <CollapsibleSection title="Access Admin Dashboard">
              <p className="text-sm text-[#8B7355] mb-4">
                Admins access the StoryBuilders waitlist dashboard at <code className="bg-[#FDF8F0] px-2 py-1 rounded text-[#3D2B1F]">/admin/storybuilders</code>. This
                requires:
              </p>
              <ul className="space-y-2 text-sm list-disc list-inside text-[#5C4033]">
          ...
          <section id="dashboard-overview" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#8BA888]/20 flex items-center justify-center">
                <BarChart3 className="h-6 w-6 text-[#8BA888]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Dashboard Overview</h2>
            </div>

            <CollapsibleSection title="Key Metrics">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold mb-2 text-[#3D2B1F]">Total Signups</p>
                  <p className="text-[#8B7355]">Count of all email submissions</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold mb-2 text-[#3D2B1F]">Verification Rate (%)</p>
                  <p className="text-[#8B7355]">Verified emails / total signups × 100</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold mb-2 text-[#3D2B1F]">Average Referrals</p>
                  <p className="text-[#8B7355]">Mean referral count per user</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold mb-2 text-[#3D2B1F]">Conversion Rate (%)</p>
                  <p className="text-[#8B7355]">Percentage of signups reaching Tier 5</p>
                </div>
              </div>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="Quick Actions">
              ...
              <ul className="space-y-2 text-sm text-[#5C4033]">
                <li className="flex items-center gap-2">
                  <ArrowRight className="h-4 w-4 text-[#D4920B]" /> Browse Users tab
                </li>
                <li className="flex items-center gap-2">
                  <ArrowRight className="h-4 w-4 text-[#D4920B]" /> Send Email Announcement
                </li>
                <li className="flex items-center gap-2">
                  <ArrowRight className="h-4 w-4 text-[#D4920B]" /> Review Flagged Users
                </li>
                <li className="flex items-center gap-2">
                  <ArrowRight className="h-4 w-4 text-[#D4920B]" /> View Suggestions
                </li>
              </ul>
            </CollapsibleSection>
          </section>
          ...
          <section id="managing-users" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#8BA888]/20 flex items-center justify-center">
                <Users className="h-6 w-6 text-[#8BA888]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Managing Users</h2>
            </div>
            ...
            <CollapsibleSection title="Search & Filter">
              ...
              <ul className="space-y-2 text-sm list-disc list-inside mb-4 text-[#5C4033]">
                <li>Email address (partial match)</li>
                <li>Display name</li>
                <li>Referral code</li>
              </ul>
              <p className="text-sm text-[#8B7355] mb-4">Additional filters:</p>
              <ul className="space-y-2 text-sm list-disc list-inside text-[#5C4033]">
                <li>Tier (0-5)</li>
            ...
            <CollapsibleSection title="Column Meanings">
              <div className="space-y-3 text-sm">
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Email</p>
                  <p className="text-[#8B7355] text-xs">User's email address with verification status icon</p>
                </div>
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Name</p>
                  <p className="text-[#8B7355] text-xs">Display name (editable)</p>
                </div>
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Points</p>
                  <p className="text-[#8B7355] text-xs">Total points earned (signup + verify + referrals)</p>
                </div>
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Tier</p>
                  <p className="text-[#8B7355] text-xs">0-5, determines reward eligibility</p>
                </div>
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Queue Position</p>
                  <p className="text-[#8B7355] text-xs">Order for tier rewards (1 = highest tier, first in queue)</p>
                </div>
                <div className="p-3 border-l-4 border-[#D4920B] bg-[#F5EDE3] rounded">
                  <p className="font-medium text-[#3D2B1F]">Referrals</p>
                  <p className="text-[#8B7355] text-xs">Number of successful referral conversions</p>
                </div>
              </div>
            </CollapsibleSection>
...
Reason: Bonus for social media share`} />
          ...
          <section id="referral-system" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#C67B5C]/20 flex items-center justify-center">
                <Share2 className="h-6 w-6 text-[#C67B5C]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Referral System</h2>
            </div>
            ...
            <CollapsibleSection title="How Referral Codes Work">
              ...
              <ol className="space-y-2 text-sm list-decimal list-inside mb-4 text-[#5C4033]">
            ...
            <CollapsibleSection title="Points Awarded">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-4">
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-l-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">Signup</p>
                  <p className="text-2xl font-bold text-[#C67B5C]">+10</p>
                  <p className="text-[#8B7355] text-xs mt-1">User creates account</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-l-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">Email Verification</p>
                  <p className="text-2xl font-bold text-[#C67B5C]">+5</p>
                  <p className="text-[#8B7355] text-xs mt-1">User confirms email</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-l-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">Referral Conversion</p>
                  <p className="text-2xl font-bold text-[#C67B5C]">+25</p>
                  <p className="text-[#8B7355] text-xs mt-1">Referred friend verifies email</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-l-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">Social Share</p>
                  <p className="text-2xl font-bold text-[#C67B5C]">+2</p>
                  <p className="text-[#8B7355] text-xs mt-1">User clicks share button (once per platform)</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-l-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">Link Click</p>
                  <p className="text-2xl font-bold text-[#C67B5C]">+1</p>
                  <p className="text-[#8B7355] text-xs mt-1">Referral link visited</p>
                </div>
              </div>
            </CollapsibleSection>
              ...
              <div className="space-y-3 text-sm">
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 0 (Starter)</span>
                    <span className="text-[#8B7355] font-bold">0 points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Just signed up</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 1</span>
                    <span className="text-[#8B7355] font-bold">35+ points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Verified + shared with friends</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 2</span>
                    <span className="text-[#8B7355] font-bold">85+ points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Growing referral network</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 3</span>
                    <span className="text-[#8B7355] font-bold">135+ points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Multiple successful referrals</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 4</span>
                    <span className="text-[#8B7355] font-bold">260+ points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Strong viral advocate</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-[#3D2B1F]">Tier 5 (VIP)</span>
                    <span className="text-[#8B7355] font-bold">510+ points</span>
                  </div>
                  <p className="text-[#8B7355] text-xs">Top viral advocate - eligible for premium rewards</p>
                </div>
              </div>
            </CollapsibleSection>
...
3. Carol (515 points) → 3rd to receive reward`} />
          ...
          <section id="email-system" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Email System</h2>
            </div>

            <CollapsibleSection title="7 Email Templates & Triggers">
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Welcome Email</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Signup completion</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Verification Email</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Signup form submission</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Referral Bonus Notification</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Friend verifies email</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Tier Upgrade Announcement</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Points threshold reached</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Reward Fulfillment</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Admin manually sends when reward is ready</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Announcement (Bulk)</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Admin sends custom message</p>
                </div>
                <div className="p-3 bg-[#F5EDE3] rounded-lg border border-[#E8DDD0]">
                  <p className="font-semibold text-[#3D2B1F]">Account Verification Error</p>
                  <p className="text-[#8B7355] text-xs">Triggered: Email verification fails</p>
                </div>
              </div>
            </CollapsibleSection>
...
- email.complained`} />
            ...
            <CollapsibleSection title="Email Troubleshooting">
              <div className="space-y-4 text-sm">
                <div className="p-4 border border-[#C67B5C]/30 bg-[#C67B5C]/10 rounded-lg">
                  <p className="font-semibold text-[#C67B5C] mb-2">Emails not sending?</p>
                  <ul className="list-disc list-inside text-[#5C4033] space-y-1">
                ...
                <div className="p-4 border border-[#D4920B]/30 bg-[#D4920B]/10 rounded-lg">
                  <p className="font-semibold text-[#D4920B] mb-2">High bounce rate?</p>
                  <ul className="list-disc list-inside text-[#5C4033] space-y-1">
          ...
          <section id="fraud-protection" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#C67B5C]/20 flex items-center justify-center">
                <Shield className="h-6 w-6 text-[#C67B5C]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Fraud Protection</h2>
            </div>

            <CollapsibleSection title="What's Checked">
              <div className="space-y-3 text-sm">
                <div className="p-3 border-l-4 border-[#C67B5C] bg-[#F5EDE3]">
                  <p className="font-semibold text-[#3D2B1F]">Disposable Email Detection</p>
                  <p className="text-[#8B7355] text-xs mt-1">
                    Blocks temp email services (10minutemail, temp-mail, etc.)
                  </p>
                </div>
                <div className="p-3 border-l-4 border-[#C67B5C] bg-[#F5EDE3]">
                  <p className="font-semibold text-[#3D2B1F]">Duplicate Accounts</p>
                  <p className="text-[#8B7355] text-xs mt-1">
                    Detects multiple signups from same email or phone number
                  </p>
                </div>
                <div className="p-3 border-l-4 border-[#C67B5C] bg-[#F5EDE3]">
                  <p className="font-semibold text-[#3D2B1F]">IP Rate Limiting</p>
                  <p className="text-[#8B7355] text-xs mt-1">
                    Flags IPs with excessive signups in short time period
                  </p>
                </div>
                <div className="p-3 border-l-4 border-[#C67B5C] bg-[#F5EDE3]">
                  <p className="font-semibold text-[#3D2B1F]">Referral Patterns</p>
                  <p className="text-[#8B7355] text-xs mt-1">
                    Detects unrealistic referral activity (100+ referrals/day from single user)
                  </p>
                </div>
                <div className="p-3 border-l-4 border-[#C67B5C] bg-[#F5EDE3]">
                  <p className="font-semibold text-[#3D2B1F]">Email Validation</p>
                  <p className="text-[#8B7355] text-xs mt-1">
...
- 50+ verifications from same IP → Flag`} />
            ...
            <CollapsibleSection title="Approval vs Dismiss">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border border-[#8BA888]/30 bg-[#8BA888]/10 rounded-lg">
                  <p className="font-semibold text-[#8BA888]">Approve</p>
                  <p className="text-[#5C4033] text-sm mt-2">
                    User is legitimate. Remove flag, allow full participation. Points are counted.
                  </p>
                </div>
                <div className="p-4 border border-[#C67B5C]/30 bg-[#C67B5C]/10 rounded-lg">
                  <p className="font-semibold text-[#C67B5C]">Dismiss/Block</p>
                  <p className="text-[#5C4033] text-sm mt-2">
          ...
          <section id="suggestion-box" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#D4920B]/20 flex items-center justify-center">
                <Lightbulb className="h-6 w-6 text-[#D4920B]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Suggestion Box</h2>
            </div>
            ...
            <CollapsibleSection title="Kanban Workflow">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-t-4 border-[#8B7355]">
                  <p className="font-semibold text-[#3D2B1F]">1. New</p>
                  <p className="text-[#8B7355] text-sm">Just submitted, awaiting review</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-t-4 border-[#8BA888]">
                  <p className="font-semibold text-[#3D2B1F]">2. Under Review</p>
                  <p className="text-[#8B7355] text-sm">Admin evaluating feasibility</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-t-4 border-[#D4920B]">
                  <p className="font-semibold text-[#3D2B1F]">3. Planned</p>
                  <p className="text-[#8B7355] text-sm">Will be implemented in future</p>
                </div>
                <div className="p-4 bg-[#F5EDE3] rounded-lg border-t-4 border-[#C67B5C]">
                  <p className="font-semibold text-[#3D2B1F]">4. Completed</p>
                  <p className="text-[#8B7355] text-sm">Feature implemented and live</p>
                </div>
              </div>
            </CollapsibleSection>
          ...
          <section id="tier-rewards" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#8BA888]/20 flex items-center justify-center">
                <Gift className="h-6 w-6 text-[#8BA888]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Tier Rewards Fulfillment</h2>
            </div>
          ...
          <section id="troubleshooting" className="mb-12 scroll-mt-20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-[#C67B5C]/20 flex items-center justify-center">
                <AlertCircle className="h-6 w-6 text-[#C67B5C]" />
              </div>
              <h2 className="text-3xl font-bold text-[#3D2B1F] font-serif italic">Troubleshooting</h2>
            </div>

            <CollapsibleSection title="Common Issues">
              <div className="space-y-4 text-sm">
                <div className="p-4 border border-[#D4920B]/30 bg-[#D4920B]/10 rounded-lg">
                  <p className="font-semibold text-[#D4920B] mb-2">User points not updating?</p>
                ...
                <div className="p-4 border border-[#D4920B]/30 bg-[#D4920B]/10 rounded-lg">
                  <p className="font-semibold text-[#D4920B] mb-2">Referral code not generating?</p>
                  <p className="text-[#5C4033] mb-2">
                    Ensure:
                  </p>
                  <ul className="list-disc list-inside text-[#5C4033] space-y-1">
                ...
                <div className="p-4 border border-[#D4920B]/30 bg-[#D4920B]/10 rounded-lg">
                  <p className="font-semibold text-[#D4920B] mb-2">Duplicate user after merge?</p>
                  <p className="text-[#5C4033] mb-2">
...
Completes in ~2 seconds for 10k users.`} />
          ...
          <div className="mt-12 p-6 bg-[#F5EDE3] border border-[#E8DDD0] rounded-lg print:bg-gray-50 print:border-gray-300">
            <h3 className="font-semibold text-[#3D2B1F] mb-2">Need Help?</h3>
